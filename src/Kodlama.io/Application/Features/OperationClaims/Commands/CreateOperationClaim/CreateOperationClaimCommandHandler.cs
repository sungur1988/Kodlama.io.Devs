...
namespace Application.Features.OperationClaims.Commands.CreateOperationClaim
{
    public class CreateOperationClaimCommandHandler : IRequestHandler<CreateOperationClaimCommand, CreatedOperationClaimDto>
    {
        ...
        public async Task<CreatedOperationClaimDto> Handle(CreateOperationClaimCommand request, CancellationToken cancellationToken)
        {
            ...
            OperationClaim entityToAdd = _mapper.Map<OperationClaim>(request);
            OperationClaim addedEntity = await _operationClaimRepository.AddAsync(entityToAdd);
            CreatedOperationClaimDto mappedEntity = _mapper.Map<CreatedOperationClaimDto>(addedEntity);
