...
namespace Application.Services.AuthServices
{
    public class AuthManager : IAuthService
    {
        ...
        public async Task<RefreshToken> AddRefresToken(RefreshToken refreshToken)
        {
        ...
        public async Task<AccessToken> CreateAccessToken(User user)
        {
            ...
            IList<OperationClaim>? operationClaims = userOperationClaims.Items.Select(x => x.OperationClaim).ToList();
